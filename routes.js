...
mongoose.connect('mongodb+srv://rhidays:password@cluster0-v5hvq.mongodb.net/autetification_reglog?retryWrites=true&w=majority', {
                ...
                bcrypt.genSalt(10, (err, salt) => {
                    ...
                    bcrypt.hash(password, salt, (err, hash) => {
                        ...
                        user({
                            ...
                            if (err) throw err;
                            req.flash('success_mersssage', "Registered Successfully.. Login To Continue..");
                            res.redirect('/login');
                        });
                    });
                });
